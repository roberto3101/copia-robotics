...
PORTADAS = {
    ...
    'sectores': dict(fin=555, panel=560, zonas=[(30, 96, 1000, 552), (1395, 130, 1830, 552)]),
    'casos-de-uso': dict(fin=516, panel=560, zonas=[(30, 96, 1000, 513), (1600, 270, 1830, 420)]),
...
BANDAS = {
    ...
    'llamada-soluciones': dict(pagina='soluciones', ini=1466, fin=1722, panel=880,
                               zonas=[(20, 1466, 900, 1722), (940, 1466, 1830, 1722, 34)]),
    'llamada-tecnologia': dict(pagina='tecnologia', ini=1500, fin=1660, panel=880,
                               zonas=[(20, 1500, 900, 1660), (940, 1500, 1830, 1660, 34)]),
    ...
    'llamada-nosotros': dict(pagina='nosotros', ini=2257, fin=2464, panel=430,
                             zonas=[(20, 2257, 900, 2464), (1250, 2257, 1830, 2464)]),
